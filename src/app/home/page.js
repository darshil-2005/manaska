  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <header className="sticky top-0 z-50 bg-white border-b">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-6">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-black text-white rounded-lg font-bold shadow-md flex items-center justify-center text-sm sm:text-base lg:text-lg">
              M
            </div>
          ...
          {/* Desktop Navigation */}
          <nav className="hidden lg:flex space-x-6 xl:space-x-8 text-gray-600 font-medium text-sm">
          ...
          <div className="hidden sm:flex items-center gap-2 lg:gap-4">
            <Link href="/login" className="text-gray-600 hover:text-black transition px-3 lg:px-4 py-2 rounded-md hover:bg-gray-100 text-xs sm:text-sm lg:text-base">
              Sign In
            </Link>
            <Link href="/register" className="bg-black text-white px-3 sm:px-4 lg:px-6 py-2 lg:py-3 rounded-lg font-semibold shadow-lg hover:scale-105 transition text-xs sm:text-sm lg:text-base whitespace-nowrap">
              Try Free →
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="sm:hidden border-t bg-white">
            <nav className="flex flex-col px-4 py-3 space-y-3">
              <Link 
                href="#features" 
                className="text-gray-600 hover:text-black transition py-2 text-sm"
              ...
              <div className="pt-3 border-t space-y-2">
                <Link 
                  href="/login" 
                  className="block text-center text-gray-600 hover:text-black transition px-4 py-2 rounded-md hover:bg-gray-100 text-sm"
                >
                  Sign In
                </Link>
                <Link 
                  href="/register" 
                  className="block text-center bg-black text-white px-4 py-2 rounded-lg font-semibold shadow-lg text-sm"
                >
                  Try Free →
                </Link>
              </div>
      ...
      <section className="text-center py-10 sm:py-16 md:py-20 lg:py-28 px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <p className="mt-4 sm:mt-6 text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto px-2">
        ...
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-4">
          <button 
            ...
            className="bg-gray-100 border border-gray-300 text-black px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition text-sm sm:text-base w-full sm:w-auto"
          >
            See Examples
          </button>
          <button 
            onClick={() => setShowLearnMore(!showLearnMore)}
            className="bg-black text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:scale-105 transition text-sm sm:text-base w-full sm:w-auto"
          >
            Learn More
          </button>
        </div>
        ...
        {showExamples && (
          <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-gray-50 border border-gray-200 rounded-lg text-left">
            <h3 className="text-lg sm:text-xl font-bold mb-4">Example Mind Maps</h3>
            <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="p-3 sm:p-4 border border-gray-300 rounded">
                <h4 className="font-semibold mb-2 text-sm sm:text-base">Lecture Notes</h4>
                <p className="text-xs sm:text-sm text-gray-600">Convert lecture transcripts into structured study guides</p>
              </div>
              <div className="p-3 sm:p-4 border border-gray-300 rounded">
                <h4 className="font-semibold mb-2 text-sm sm:text-base">Project Planning</h4>
                <p className="text-xs sm:text-sm text-gray-600">Transform meeting notes into project timelines</p>
              </div>
              <div className="p-3 sm:p-4 border border-gray-300 rounded">
                <h4 className="font-semibold mb-2 text-sm sm:text-base">Book Summaries</h4>
                <p className="text-xs sm:text-sm text-gray-600">Create visual summaries from book chapters</p>
              </div>
              <div className="p-3 sm:p-4 border border-gray-300 rounded">
                <h4 className="font-semibold mb-2 text-sm sm:text-base">Research Papers</h4>
                <p className="text-xs sm:text-sm text-gray-600">Extract key concepts from academic papers</p>
              </div>
            </div>
            <button 
      ...
      <section id="features" className="bg-gray-50 py-10 sm:py-14 lg:py-20 px-4 sm:px-6 lg:px-8 text-center scroll-mt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 max-w-6xl mx-auto">
          <div className="px-2 sm:px-4">
            <div className="w-12 h-12 bg-black text-white rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4 text-xl">📥</div>
            <h3 className="font-semibold mb-2 text-base sm:text-lg lg:text-xl">Import anything</h3>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">Paste text, upload documents, or input any content. Manaska works with PDFs, articles, notes, and more.</p>
          </div>
          <div className="px-2 sm:px-4">
            <div className="w-12 h-12 bg-black text-white rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4 text-xl">⚡</div>
            <h3 className="font-semibold mb-2 text-base sm:text-lg lg:text-xl">Instant processing</h3>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">AI analyzes and structures your content in seconds, identifying key concepts and relationships automatically.</p>
          </div>
          <div className="px-2 sm:px-4 sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">Download as PNG, PDF, or editable formats. Use your mind maps in presentations, documents, or other tools.</p>
          </div>
        </div>
      </section>
      ...
      <section id="how" className="py-10 sm:py-14 lg:py-20 px-4 sm:px-6 lg:px-8 text-center scroll-mt-20">
        ...
        <p className="text-xs sm:text-sm lg:text-base text-gray-600 mb-6 sm:mb-10 lg:mb-12 px-2">Three simple steps to transform your content into mind maps</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 max-w-6xl mx-auto">
          <div className="px-2 sm:px-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full bg-black text-white flex items-center justify-center mx-auto mb-3 sm:mb-4 text-lg sm:text-xl lg:text-2xl font-bold">1</div>
            <h3 className="font-semibold mb-2 text-base sm:text-lg lg:text-xl">Input your content</h3>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">Paste text, upload documents, or type your ideas directly. Any format works.</p>
          </div>
          <div className="px-2 sm:px-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full bg-black text-white flex items-center justify-center mx-auto mb-3 sm:mb-4 text-lg sm:text-xl lg:text-2xl font-bold">2</div>
            <h3 className="font-semibold mb-2 text-base sm:text-lg lg:text-xl">AI processes</h3>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">Manaska analyzes your content and identifies key concepts, themes, and relationships.</p>
          </div>
          <div className="px-2 sm:px-4 sm:col-span-2 lg:col-span-1">
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full bg-black text-white flex items-center justify-center mx-auto mb-3 sm:mb-4 text-lg sm:text-xl lg:text-2xl font-bold">3</div>
            <h3 className="font-semibold mb-2 text-base sm:text-lg lg:text-xl">Get your mind map</h3>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">Receive a beautiful, structured mind map ready to use, edit, or share.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 text-left">
            <div className="bg-gray-50 p-5 sm:p-6 rounded-lg border border-gray-200">
              ...
              <ul className="text-gray-600 space-y-2 text-xs sm:text-sm">
      ...
      <section id="use-cases" className="py-10 sm:py-14 lg:py-24 px-4 sm:px-6 text-center bg-gray-50 scroll-mt-20">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2 sm:mb-3 lg:mb-4">Who Uses ManaskaAI?</h2>
        <p className="text-xs sm:text-sm lg:text-base text-gray-600 mb-6 sm:mb-10 lg:mb-12 max-w-2xl mx-auto px-2">
          Join thousands of professionals, students, and creatives
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto">
          <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl lg:rounded-2xl p-5 sm:p-6 lg:p-8 text-center">
          ...
          <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl lg:rounded-2xl p-5 sm:p-6 lg:p-8 text-center sm:col-span-2 lg:col-span-1">
            <div className="text-2xl sm:text-3xl lg:text-4xl mb-2 sm:mb-3 lg:mb-4">🎨</div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 text-center text-white bg-black">
        <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Ready to Get Started?</h2>
        <Link href="/register" className="bg-white text-black font-semibold px-6 sm:px-8 py-3 rounded-lg shadow-lg hover:scale-105 transition inline-flex items-center gap-2 text-sm sm:text-base">
          Start Free Now →
        </Link>
      </section>
